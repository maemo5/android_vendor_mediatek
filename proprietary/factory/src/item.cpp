...
#endif
/* Vanzo:songlixin on: Thu, 14 May 2015 17:18:50 +0800
 */
#ifdef FEATURE_FTM_HALL
    item(ITEM_HALL, "AT+HALL"),
#endif
#ifdef FEATURE_FTM_FINGERPRINT
    item(ITEM_FINGERPRINT, "AT+FINGERPRINT"),
#endif
#ifdef FEATURE_FTM_BLED
    item(ITEM_BLED, "AT+BLED"),
#endif
#ifdef FEATURE_FTM_ATP
    item(ITEM_ATP, "AT+ATP"),
#endif
#ifdef FEATURE_FTM_IRTX_LED
    item(ITEM_IRTX_LED_TEST, "AT+IRTX"),
#endif
...
/* Vanzo:songlixin on: Thu, 14 May 2015 17:20:24 +0800
 */
#ifdef FEATURE_FTM_HALL
...
#endif
#ifdef FEATURE_FTM_BLED
    item(ITEM_BLED,  uistr_bled),
#endif
#ifdef FEATURE_FTM_ATP
    item(ITEM_ATP,  uistr_atp),
#endif
// End of Vanzo:songlixin
