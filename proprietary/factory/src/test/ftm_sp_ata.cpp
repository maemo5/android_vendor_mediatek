...
static ftm_cmd_hdlr cmd_hdlr[]={
    ...
    #ifdef FEATURE_FTM_LED
/* Vanzo:songlixin on: Tue, 14 Jul 2015 16:14:33 +0800
        {19, ITEM_LED, "AT+LED", (hdlr)ftm_item_add_cb},
 */
        {19, ITEM_LED, "AT+LED", (hdlr)ftm_item_entry_cb},
// End of Vanzo: songlixin
	...
	#endif
/* Vanzo:maxiaojun on: Sat, 25 Oct 2014 13:21:06 +0800
 */
    #ifdef FEATURE_FTM_HALL
        {38, ITEM_HALL, "AT+HALL", (hdlr)ftm_item_entry_cb},
	#endif
    #ifdef FEATURE_FTM_FINGERPRINT
        {39, ITEM_FINGERPRINT, "AT+FINGERPRINT", (hdlr)ftm_item_entry_cb},
	#endif
    #ifdef FEATURE_FTM_BLED
        {40, ITEM_BLED, "AT+BLED", (hdlr)ftm_item_entry_cb},
    #endif
    #ifdef FEATURE_FTM_IRTX_LED
        {41, ITEM_IRTX_LED_TEST, "AT+IRTX", (hdlr)ftm_item_entry_cb},
    #endif
    #ifdef FEATURE_FTM_TOUCH
        {42, ITEM_TOUCH, "AT+MTOUCH", (hdlr)ftm_item_entry_cb},
    #endif
    #ifdef FEATURE_FTM_ATP
        {43, ITEM_ATP, "AT+ATP", (hdlr)ftm_item_entry_cb},
    #endif
    //item(ITEM_OTOUCH, "AT+OTOUCH"),
    //item(ITEM_NFC, "AT+NFC"),
...
int get_at_cmd_index(at_cmd *at_cmd_struct, ftm_cmd_hdlr *at_cmd_hdlr)
{
    ...
    {
/* Vanzo:songlixin on: Sat, 18 Apr 2015 17:57:25 +0800
