...
/*---------------------------------------------------------------------------*/
/* Vanzo:maxiaojun on: Tue, 19 Aug 2014 14:39:09 +0800
 */
...
/* Vanzo:maxiaojun on: Tue, 19 Aug 2014 14:40:22 +0800
 */
    if(get_is_ata() == 1){
        write_int(VIBRATOR_ENABLE, 20*1000);
    }
// End of Vanzo:maxiaojun
...
/* Vanzo:maxiaojun on: Tue, 19 Aug 2014 14:40:52 +0800
 */
 	if(get_is_ata() == 1){
