...
/* Vanzo:songlixin on: Thu, 28 May 2015 17:25:13 +0800
    magLower = 1000;
 */
    magLower = 5000000;
...
/* Vanzo:songlixin on: Thu, 28 May 2015 17:22:36 +0800
 ...
 */
	    if ((magDataL[0] <= magUpper && magDataL[0] >= magLower)&& (magDataR[0] <= magUpper && magDataR[0] >= magLower))
// End of Vanzo: songlixin
		{
		    checkCnt ++;	
            if(checkCnt >= 5)
...
/* Vanzo:songlixin on: Thu, 28 May 2015 14:43:54 +0800
