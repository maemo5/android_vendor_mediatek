...
public class SlotSettingsFragment extends PreferenceFragment {
   ...
   /**
    ...
    public static boolean externalSlotInRoamingService(ServiceState serviceState) {
        boolean isInService = (serviceState.getDataRegState() == ServiceState.STATE_IN_SERVICE)
        ...
        Xlog.d(TAG, "externalSlotInRoamingService,  isInService : " + isInService
                   + ", isRoamingMode : " + isRoamingMode);
        return isInService && isRoamingMode;
    }
