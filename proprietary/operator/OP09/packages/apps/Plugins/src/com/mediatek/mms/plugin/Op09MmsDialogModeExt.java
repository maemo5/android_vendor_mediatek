...
public class Op09MmsDialogModeExt extends DefaultMmsDialogModeExt {
    ...
    @Override
    public void setSimTypeDrawable(Context context, long subId, TextView textView) {
        ...
        int slotId = -1;
        if (simInfo != null) {
            slotId = simInfo.getSimSlotIndex();
            /// FIXME
//            int sysResId = simInfo.simIconRes[3];
            ...
            if (sysResId > 0) {
                ...
                Xlog.e(TAG, "[showSimType], get icon res from subInfo.simIconRes[3]"
                    + " failed. res = " + sysResId);
        ...
        Xlog.d(TAG, "showSimType for DialogModel; slotId:" + slotId);
        if (textView != null) {
            textView.setText("");
