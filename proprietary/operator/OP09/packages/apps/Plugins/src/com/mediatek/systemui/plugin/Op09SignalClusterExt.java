...
public class Op09SignalClusterExt extends BaseSignalClusterExt {
    ...
    private class Op09PhoneStateExt extends BasePhoneStateExt {
        ...
        private final void setViews() {
            ...
            mMobileNetworkDataGroup = new FrameLayout(mContext);
        ...
        private boolean isShowSignalStrengthTower(final int[] iconLevelTower) {
            ...
            Log.d(TAG, "applyMobileSignalStrength(), slotId=" + mSlotId
        ...
        protected void applyNetworkDataType() {
            if (DEBUG) {
                Log.d(TAG, "applyNetworkDataType(), mDataConnectioned= " + mDataConnectioned);
            }
