...
public abstract class CancellableTask implements Runnable {
    ...
    protected final IPAServiceCallback mCallback;
    private int mCancelReason = Constants.INVALID;
    private boolean mIsBackground = false;
    
    public CancellableTask(long requestId, IPAServiceCallback callback) {
        this(requestId, callback, false);
    }
    
    public CancellableTask(long requestId, IPAServiceCallback callback, boolean isBackground) {
        mId = requestId;
        mCallback = callback;
