...
public class AccountSearchActivity extends ClientQueryActivity<PublicAccount> {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setQueryHint(getString(R.string.hint_search_public_accounts));
        ...
        mSearchView.setOnQueryTextListener(new OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (mKey.length() > 0 && mKey.length() <= MAX_LENGTH) {
                    ...
                    String hint = getResources().getString(R.string.hint_max_length, MAX_LENGTH);
    ...
    protected List<PublicAccount> searchDataViaClient() throws PAMException {
        return mUIPAMClient.search(mKey, mOrder, mPageSize, mPageNum);
    }

    @Override
    protected void doWhenResultNormal(List<PublicAccount> list) {
        super.doWhenResultNormal(list);
        sortAccountViaTitle(list);
    }
    ...
    protected void startFirstQuery() {
        ...
        if (!isServiceConnected()) {
            String text = getResources().getString(R.string.text_service_not_connect);
    ...
    @Override
    protected void updateListonUI(List<PublicAccount> listSearch, final int type) {
