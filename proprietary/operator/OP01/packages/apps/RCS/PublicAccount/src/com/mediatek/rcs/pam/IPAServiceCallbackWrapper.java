...
public final class IPAServiceCallbackWrapper extends IPAServiceCallback.Stub {
    ...
    @Override
    public void onTransferProgress(final long messageId, final long currentSize, final long totalSize)
    ...
    @Override
    public void reportSubscribeResult(final long requestId, final int resultCode) throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                try {
    ...
    @Override
    public void reportUnsubscribeResult(final long requestId, final int resultCode) throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                try {
    ...
    @Override
    public void reportGetSubscribedResult(final long requestId, final int resultCode, final long[] accountIds)
            throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void reportGetDetailsResult(final long requestId, final int resultCode, final long accountId)
            throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void reportGetMenuResult(final long requestId, final int resultCode) throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                try {
    ...
    @Override
    public void reportDownloadResult(final long requestId, final int resultCode, final String path, final long mediaId)
            throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void updateDownloadProgress(final long requestId, final int percentage) throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                try {
    ...
    @Override
    public void reportSetAcceptStatusResult(final long requestId, final int resultCode) throws RemoteException {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                try {
    ...
    @Override
    public void reportComplainSpamFailed(final long messageId, final int errorCode) throws RemoteException {
        mHandler.post(new Runnable() {
