...
/**
 * Default implementation of IPAServiceCallback.Stub which do nothing. This class is used to simplify the implementation
 * of callbacks.
 */
public abstract class SimpleServiceCallback extends IPAServiceCallback.Stub {
    ...
    // throw new Error("You have to override this method. Don't invoke super.onServiceDisconnected() when overriding");
    // }
    //
    // @Override
    ...
    @Override
    public void reportGetSubscribedResult(long requestId, int resultCode, long[] accountIds) throws RemoteException {
        // TODO Auto-generated method stub
    ...
    @Override
    public void reportDownloadResult(long requestId, int resultCode, String path, long mediaId) throws RemoteException {
        // TODO Auto-generated method stub
