...
import com.mediatek.rcs.pam.provider.PAContract.CcsMediaType;
...
public class PAProvider extends ContentProvider {
    ...
    private interface UriCode {
        ...
        /* CMCC only */
        int CCS_ACCOUNTS = 100;
        int CCS_ACCOUNT_INFOES = 101;
        int CCS_SEARCH_RESULTS = 102;
    }
    ...
    static {
        ...
        URI_MATCHER.addURI(PAContract.AUTHORITY, "message_history_summaries", UriCode.MESSAGE_HISTORY_SUMMARIES);
        URI_MATCHER.addURI(PAContract.AUTHORITY, "state", UriCode.STATE);

        /* CMCC only */
        URI_MATCHER.addURI(PAContract.CCS_ACCOUNT_AUTHORITY, null, UriCode.CCS_ACCOUNTS);
        URI_MATCHER.addURI(PAContract.CCS_ACCOUNT_INFO_AUTHORITY, null, UriCode.CCS_ACCOUNT_INFOES);
        URI_MATCHER.addURI(PAContract.CCS_ACCOUNT_SEARCH_AUTHORITY, null, UriCode.CCS_SEARCH_RESULTS);
    }
    ...
    class PADatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + Tables.ACCOUNT + "(" + AccountColumns._ID
                    + " INTEGER PRIMARY KEY AUTOINCREMENT," + AccountColumns.UUID + " TEXT NOT NULL UNIQUE,"
                    + AccountColumns.NAME + " TEXT," + AccountColumns.ID_TYPE + " INTEGER,"
                    + AccountColumns.INTRODUCTION + " TEXT," + AccountColumns.RECOMMEND_LEVEL + " INTEGER DEFAULT 1,"
                    + AccountColumns.LOGO_ID + " INTEGER," + AccountColumns.SUBSCRIPTION_STATUS + " INTEGER NOT NULL,"
                    + AccountColumns.COMPANY + " TEXT," + AccountColumns.TYPE + " TEXT," + AccountColumns.UPDATE_TIME
                    + " INTEGER," + AccountColumns.MENU_TYPE + " INTEGER," + AccountColumns.MENU_TIMESTAMP
                    + " INTEGER," + AccountColumns.ACCEPT_STATUS + " INTEGER," + AccountColumns.ACTIVE_STATUS
                    + " INTEGER," + AccountColumns.TELEPHONE + " TEXT," + AccountColumns.EMAIL + " TEXT,"
                    + AccountColumns.ZIPCODE + " TEXT," + AccountColumns.ADDRESS + " TEXT," + AccountColumns.FIELD
                    + " TEXT," + AccountColumns.QRCODE_URL + " TEXT,"
            ...
            db.execSQL("CREATE TABLE " + Tables.MEDIA_BASIC + "("
                    + MediaBasicColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            ...
            db.execSQL("CREATE TABLE " + Tables.MEDIA_ARTICLE + "("
                    + MediaArticleColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    ...
                    + MediaArticleColumns.MEDIA_UUID + " TEXT UNIQUE NOT NULL);");

            db.execSQL("CREATE TABLE " + Tables.MEDIA + "("
                    + MediaColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + MediaColumns.TYPE + " INTEGER,"
                    + MediaColumns.TIMESTAMP + " INTEGER,"
                    + MediaColumns.PATH + " TEXT,"
                    + MediaColumns.URL + " TEXT UNIQUE);");

            db.execSQL("CREATE VIRTUAL TABLE " + Tables.SEARCH + " USING FTS4(" + SearchColumns.ACCOUNT_ID
                    + " INTEGER," + SearchColumns.ACCOUNT_NAME + " TEXT," + SearchColumns.MESSAGE_TEXT + " TEXT,"
                    + SearchColumns.MESSAGE_SUMMARY + " TEXT," + SearchColumns.MESSAGE_MEDIA_TITLE1 + " TEXT,"
                    + SearchColumns.MESSAGE_MEDIA_TITLE2 + " TEXT," + SearchColumns.MESSAGE_MEDIA_TITLE3 + " TEXT,"
                    + SearchColumns.MESSAGE_MEDIA_TITLE4 + " TEXT," + SearchColumns.MESSAGE_MEDIA_TITLE5 + " TEXT,"
                    + SearchColumns.MESSAGE_ARTICLE_TEXT1 + " TEXT," + SearchColumns.MESSAGE_ARTICLE_TEXT2 + " TEXT,"
                    + SearchColumns.MESSAGE_ARTICLE_TEXT3 + " TEXT," + SearchColumns.MESSAGE_ARTICLE_TEXT4 + " TEXT,"
                    + SearchColumns.MESSAGE_ARTICLE_TEXT5 + " TEXT," + " TOKENIZE=porter);");

            db.execSQL("CREATE VIEW " + Tables.MESSAGE_HISTORY_SUMMARY_VIEW + " AS SELECT "
                    + Tables.ACCOUNT + "." + AccountColumns._ID + " AS " + MessageHistorySummaryColumns._ID + ", "
                    + Tables.ACCOUNT + "." + AccountColumns.UUID + " AS " + MessageHistorySummaryColumns.UUID + ","
                    + Tables.ACCOUNT + "." + AccountColumns.NAME + " AS " + MessageHistorySummaryColumns.NAME + ","
                    + Tables.ACCOUNT + "." + AccountColumns.LOGO_ID + " AS " + MessageHistorySummaryColumns.LOGO_ID + ","
                    + Tables.MEDIA + "." + MediaColumns.PATH + " AS " + MessageHistorySummaryColumns.LOGO_PATH + ","
                    + Tables.MEDIA + "." + MediaColumns.URL + " AS " + MessageHistorySummaryColumns.LOGO_URL + ","
                    + AccountColumns.LAST_MESSAGE + " AS " + MessageHistorySummaryColumns.LAST_MESSAGE_ID + ","
                    + Tables.MESSAGE + "." + MessageColumns.TYPE + " AS " + MessageHistorySummaryColumns.LAST_MESSAGE_TYPE + ","
                    + "MAX(" + Tables.MESSAGE + "." + MessageColumns.TIMESTAMP + ") AS " + MessageHistorySummaryColumns.LAST_MESSAGE_TIMESTAMP + ","
                    + Tables.MESSAGE + "." + MessageColumns.SMS_DIGEST + " AS " + MessageHistorySummaryColumns.LAST_MESSAGE_SUMMARY
                    + " FROM ((" + Tables.ACCOUNT
                    + " LEFT OUTER JOIN " + Tables.MEDIA + " ON " + Tables.ACCOUNT + "." + AccountColumns.LOGO_ID + "="
                    + Tables.MEDIA + "." + MediaColumns._ID + ")" + " LEFT OUTER JOIN " + Tables.MESSAGE + " ON "
                    + Tables.ACCOUNT + "." + AccountColumns.LAST_MESSAGE + "=" + Tables.MESSAGE + "."
                    + MessageColumns._ID + ")" + " GROUP BY " + Tables.ACCOUNT + "." + MessageHistorySummaryColumns._ID
                    + " ORDER BY " + MessageHistorySummaryColumns.LAST_MESSAGE_TIMESTAMP + " DESC;");

            /* CMCC only */
            db.execSQL("CREATE TABLE " + Tables.CCS_SEARCH + "("
            ...
            db.execSQL("CREATE VIEW " + Tables.CCS_ACCOUNT_VIEW + " AS SELECT "
                    + Tables.ACCOUNT + "." + AccountColumns._ID + " AS " + CcsAccountColumns.ID + ", "
                    + AccountColumns.UUID + " AS " + CcsAccountColumns.ACCOUNT + ", "
                    + Tables.ACCOUNT + "." + AccountColumns.NAME + " AS " + CcsAccountColumns.NAME + ", "
                    + Tables.MEDIA + "." + MediaColumns.URL + " AS " + CcsAccountColumns.PORTRAIT + ", "
                    + Tables.MEDIA + "." + MediaColumns.PATH + " AS " + CcsAccountColumns.PORTRAIT_PATH + ", "
                    + AccountColumns.INTRODUCTION + " AS " + CcsAccountColumns.BREIF_INTRODUCTION
                    + " FROM " + Tables.ACCOUNT
                    + " LEFT OUTER JOIN " + Tables.MEDIA + " ON " + Tables.ACCOUNT + "." + AccountColumns.LOGO_ID + "="
                    + Tables.MEDIA + "." + MediaColumns._ID
                    + " WHERE " + AccountColumns.SUBSCRIPTION_STATUS + "=" + Constants.SUBSCRIPTION_STATUS_YES + ";");

            db.execSQL("CREATE VIEW " + Tables.CCS_ACCOUNT_INFO_VIEW + " AS SELECT "
                    + Tables.ACCOUNT + "." + AccountColumns._ID + " AS " + CcsAccountInfoColumns.ID + ", "
                    + AccountColumns.UUID + " AS " + CcsAccountInfoColumns.ACCOUNT + ", "
                    + Tables.ACCOUNT + "." + AccountColumns.NAME + " AS " + CcsAccountInfoColumns.NAME + ", "
                    + Tables.MEDIA + "." + MediaColumns.URL + " AS " + CcsAccountInfoColumns.PORTRAIT + ", "
                    + Tables.MEDIA + "." + MediaColumns.PATH + " AS " + CcsAccountColumns.PORTRAIT_PATH + ", "
                    + AccountColumns.INTRODUCTION + " AS " + CcsAccountInfoColumns.BREIF_INTRODUCTION + ", "
                    + AccountColumns.SUBSCRIPTION_STATUS + " AS " + CcsAccountInfoColumns.STATE + ", "
                    + AccountColumns.MENU + " AS " + CcsAccountInfoColumns.CONFIG
                    + " FROM " + Tables.ACCOUNT
                    + " LEFT OUTER JOIN " + Tables.MEDIA + " ON " + Tables.ACCOUNT + "." + AccountColumns.LOGO_ID + "="
                    + Tables.MEDIA + "." + MediaColumns._ID + ";");
            ...
            db.execSQL("CREATE TABLE " + Tables.STATE + "("
                    + StateColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // CMCC only tables
            db.execSQL("DROP TABLE IF EXISTS " + Tables.CCS_SEARCH);
    ...
    public String getType(Uri uri) {
        ...
        case UriCode.CCS_ACCOUNT_INFOES:
            return "vnd.android.cursor.dir/ccs_pa_account_info";
        case UriCode.CCS_SEARCH_RESULTS:
            return "vnd.android.cursor.dir/ccs_pa_search_result";
        default:
        ...
        try {
            ...
            case UriCode.ACCOUNTS_ID:
                count = db.delete(Tables.ACCOUNT,
                        AccountColumns._ID + "=" + uri.getPathSegments().get(1)
            ...
            case UriCode.MESSAGES:
                {
                    ...
                    try {
                        c = db.query(Tables.MESSAGE, new String[] { MessageColumns._ID, MessageColumns.ACCOUNT_ID }, where,
                                whereArgs, null, null, null);
                        if (c != null && c.getCount() > 0) {
                            final int messageIdIndex = c.getColumnIndexOrThrow(MessageColumns._ID);
                            final int accountIdIndex = c.getColumnIndexOrThrow(MessageColumns.ACCOUNT_ID);
                            c.moveToFirst();
                            do {
                                infoList.add(new Pair(c.getLong(messageIdIndex), c.getLong(accountIdIndex)));
                            } while (c.moveToNext());
                        }
                    } finally {
                        if (c != null) {
                    ...
                    SQLiteStatement deleteSearchStatement = db.compileStatement("DELETE FROM " + Tables.SEARCH + " WHERE "
                            + SearchColumns.ROWID + "=?");
            ...
            case UriCode.MESSAGES_ID:
                {
                    ...
                    count = db.delete(Tables.MESSAGE, AccountColumns._ID + "=" + id
                            + (TextUtils.isEmpty(where) ? null : " AND (" + where + ")"), whereArgs);
            ...
            case UriCode.MEDIA_BASICS:
                ...
                break;
            case UriCode.MEDIA_BASICS_ID:
                count = db.delete(Tables.MEDIA_BASIC, AccountColumns._ID + "=" + uri.getPathSegments().get(1)
                        + (TextUtils.isEmpty(where) ? null : " AND (" + where + ")"), whereArgs);
                break;
            case UriCode.MEDIA_ARTICLES:
                ...
                break;
            case UriCode.MEDIA_ARTICLES_ID:
                count = db.delete(Tables.MEDIA_ARTICLE, AccountColumns._ID + "=" + uri.getPathSegments().get(1)
                        + (TextUtils.isEmpty(where) ? null : " AND (" + where + ")"), whereArgs);
                break;
            case UriCode.MEDIAS:
            ...
            case UriCode.CCS_SEARCH_RESULTS:
                ...
                count = db.delete(Tables.CCS_SEARCH, where, whereArgs);
                break;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            ...
            case UriCode.CCS_SEARCH_RESULTS:
                // FIXME throw exception here and add a new private uri for inserting by PAService
                id = db.insert(Tables.CCS_SEARCH, null, values);
                break;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        case UriCode.ACCOUNTS:
            if (detectAndWrapLogoFields(projection)) {
                final String tableString = Tables.ACCOUNT + " LEFT OUTER JOIN " + Tables.MEDIA + " ON("
                        + Tables.ACCOUNT + "." + AccountColumns.LOGO_ID + "=" + Tables.MEDIA + "." + MediaColumns._ID
                        + ")";
        ...
        case UriCode.ACCOUNTS_ID:
            if (detectAndWrapLogoFields(projection)) {
                queryBuilder.setTables(Tables.ACCOUNT + " LEFT OUTER JOIN " + Tables.MEDIA + " ON(" + Tables.ACCOUNT
                        + "." + AccountColumns.LOGO_ID + "=" + Tables.MEDIA + "." + MediaColumns._ID + ")");
            } else {
                queryBuilder.setTables(Tables.ACCOUNT);
            }
            queryBuilder.appendWhere(AccountColumns._ID + "=" + uri.getPathSegments().get(1));
            break;
        case UriCode.MESSAGES:
            {
                ...
                try {
                    includingDeleted = flag == null ? Constants.INCLUDING_DELETED_NO : Integer.parseInt(flag);
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                ...
                if (includingSystem != Constants.IS_SYSTEM_YES) {
                    if (selectionArgs != null) {
                        ...
                        newSelectionArgs[selectionArgs.length] = Integer.toString(Constants.IS_SYSTEM_NO);
        ...
        case UriCode.MESSAGES_ID:
            queryBuilder.setTables(Tables.MESSAGE);
            queryBuilder.appendWhere(MessageColumns._ID + "=" + uri.getPathSegments().get(1));
            break;
        case UriCode.MEDIA_BASICS:
        ...
        case UriCode.MEDIA_BASICS_ID:
            queryBuilder.setTables(Tables.MEDIA_BASIC);
            queryBuilder.appendWhere(MediaBasicColumns._ID + "=" + uri.getPathSegments().get(1));
            break;
        case UriCode.MEDIA_ARTICLES:
        ...
        case UriCode.MEDIA_ARTICLES_ID:
            queryBuilder.setTables(Tables.MEDIA_ARTICLE);
            queryBuilder.appendWhere(MediaArticleColumns._ID + "=" + uri.getPathSegments().get(1));
            break;
        case UriCode.MEDIAS:
        ...
        case UriCode.MEDIAS_ID:
            ...
            queryBuilder.appendWhere(MediaColumns._ID + "=" + uri.getPathSegments().get(1));
            break;
        case UriCode.SEARCH:
            {
                String keywords = uri.getQueryParameter(PAContract.SEARCH_PARAM_KEYWORD);
                ...
                queryBuilder.setTables(
                        ...
                        "." + AccountColumns._ID + ") LEFT OUTER JOIN " + Tables.MEDIA +
                        " ON (" + Tables.ACCOUNT + "." + AccountColumns.LOGO_ID + "=" +
                        Tables.MEDIA + "." + MediaColumns._ID + ")");
                queryBuilder.appendWhere(
                        Tables.MESSAGE + "." + MessageColumns._ID + " IN ( SELECT "
        ...
        case UriCode.CCS_ACCOUNTS:
            ...
            if (containsColumn(projection, CcsAccountColumns.PORTRAIT_TYPE)) {
                ...
                sb.append("CASE ")
                  .append("WHEN ").append(CcsAccountColumns.PORTRAIT).append(" LIKE '%.jpg' THEN 'JPG' ")
                  .append("WHEN ").append(CcsAccountColumns.PORTRAIT).append(" LIKE '%.jpeg' THEN 'JPG' ")
                  .append("WHEN ").append(CcsAccountColumns.PORTRAIT).append(" LIKE '%.png' THEN 'PNG' ")
                  .append("WHEN ").append(CcsAccountColumns.PORTRAIT).append(" LIKE '%.bmp' THEN 'BMP' ")
                  .append("WHEN ").append(CcsAccountColumns.PORTRAIT).append(" LIKE '%.gif' THEN 'GIF' ")
        ...
        case UriCode.CCS_ACCOUNT_INFOES:
            ...
            if (containsColumn(projection, CcsAccountInfoColumns.PORTRAIT_TYPE)) {
                ...
                sb.append("CASE ")
                  .append("WHEN ").append(CcsAccountInfoColumns.PORTRAIT).append(" LIKE '%.jpg' THEN 'JPG' ")
                  .append("WHEN ").append(CcsAccountInfoColumns.PORTRAIT).append(" LIKE '%.jpeg' THEN 'JPG' ")
                  .append("WHEN ").append(CcsAccountInfoColumns.PORTRAIT).append(" LIKE '%.png' THEN 'PNG' ")
                  .append("WHEN ").append(CcsAccountInfoColumns.PORTRAIT).append(" LIKE '%.bmp' THEN 'BMP' ")
                  .append("WHEN ").append(CcsAccountInfoColumns.PORTRAIT).append(" LIKE '%.gif' THEN 'GIF' ")
                  .append("ELSE NULL END ")
            ...
            break;
        case UriCode.CCS_SEARCH_RESULTS:
            queryBuilder.setTables(Tables.CCS_SEARCH);
            break;
        case UriCode.STATE:
    ...
    private String getCcsPortraitType(String path) {
        String extension = MediaFolder.extractExtension(path);
        if (".bmp".equalsIgnoreCase(extension)) {
            return CcsMediaType.BMP;
        } else if (".gif".equalsIgnoreCase(extension)) {
            return CcsMediaType.GIF;
        } else if (".jpg".equalsIgnoreCase(extension)) {
            return CcsMediaType.JPEG;
        } else if (".jpeg".equalsIgnoreCase(extension)) {
            return CcsMediaType.JPEG;
        } else if (".png".equalsIgnoreCase(extension)) {
            return CcsMediaType.PNG;
        } else {
            return null;
        }
    }
    ...
    private boolean detectAndWrapLogoFields(String[] projection) {
        ...
        for (int i = 0; i < projection.length; ++i) {
            ...
            if (p.equals(AccountColumns._ID)) {
                projection[i] = Tables.ACCOUNT + "." + AccountColumns._ID + " AS " + AccountColumns._ID;
            } else if (p.equals(AccountColumns.LOGO_PATH)) {
                projection[i] = Tables.MEDIA + "." + MediaColumns.PATH + " AS " + AccountColumns.LOGO_PATH;
                flag = true;
            } else if (p.equals(AccountColumns.LOGO_URL)) {
                projection[i] = Tables.MEDIA + "." + MediaColumns.URL + " AS " + AccountColumns.LOGO_URL;
                flag = true;
            }
        }
        return flag;
    ...
    static {
        SEARCH_COLUMN_MAPPING.put(SearchColumns.ACCOUNT_ID, Tables.ACCOUNT + "." + AccountColumns._ID + " AS " + SearchColumns.ACCOUNT_ID);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.ACCOUNT_NAME, Tables.ACCOUNT + "." + AccountColumns.NAME + " AS " + SearchColumns.ACCOUNT_NAME);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.ACCOUNT_LOGO_ID, Tables.ACCOUNT + "." + AccountColumns.LOGO_ID + " AS " + SearchColumns.ACCOUNT_LOGO_ID);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.ACCOUNT_LOGO_PATH, Tables.MEDIA + "." + MediaColumns.PATH + " AS " + SearchColumns.ACCOUNT_LOGO_PATH);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.ACCOUNT_LOGO_URL, Tables.MEDIA + "." + MediaColumns.URL + " AS " + SearchColumns.ACCOUNT_LOGO_URL);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.MESSAGE_TIMESTAMP, Tables.MESSAGE + "." + MessageColumns.TIMESTAMP + " AS " + SearchColumns.MESSAGE_TIMESTAMP);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.MESSAGE_ID, Tables.MESSAGE + "." + MessageColumns._ID + " AS " + SearchColumns.MESSAGE_ID);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.MESSAGE_TEXT, Tables.MESSAGE + "." + MessageColumns.TEXT + " AS " + SearchColumns.MESSAGE_TEXT);
        SEARCH_COLUMN_MAPPING.put(SearchColumns.MESSAGE_SUMMARY, Tables.MESSAGE + "." + MessageColumns.SMS_DIGEST + " AS " + SearchColumns.MESSAGE_SUMMARY);
    }
    
    private static final String[] SEARCH_PROJECTION = new String[] {
        Tables.MESSAGE + "." + MessageColumns._ID + " AS " + SearchColumns._ID,
        Tables.ACCOUNT + "." + AccountColumns._ID + " AS " + SearchColumns.ACCOUNT_ID,
        ...
        Tables.MESSAGE + "." + MessageColumns._ID + " AS " + SearchColumns.MESSAGE_ID,
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        ...
        try {
            ...
            case UriCode.ACCOUNTS_ID:
                count = db
                        .update(Tables.ACCOUNT, values, AccountColumns._ID + "=" + uri.getPathSegments().get(1), null);
                break;
            case UriCode.MESSAGES:
                {
                    Cursor c = null;
            ...
            case UriCode.MESSAGES_ID:
                final long id = Long.parseLong(uri.getPathSegments().get(1));
                count = db.update(Tables.MESSAGE, values, MessageColumns._ID + "=" + id, null);
            ...
            case UriCode.MEDIA_BASICS:
                ...
                break;
            case UriCode.MEDIA_BASICS_ID:
                count = db.update(Tables.MEDIA_BASIC, values, MediaBasicColumns._ID + "="
            ...
            case UriCode.MEDIA_ARTICLES:
                ...
                break;
            case UriCode.MEDIA_ARTICLES_ID:
                count = db.update(Tables.MEDIA_ARTICLE, values, MediaArticleColumns._ID + "="
                        + uri.getPathSegments().get(1), null);
                break;
            case UriCode.MEDIAS:
                ...
                break;
            case UriCode.MEDIAS_ID:
                count = db.update(Tables.MEDIA, values, MediaColumns._ID + "=" + uri.getPathSegments().get(1), null);
                break;
            case UriCode.SEARCH:
                throw new UnsupportedOperationException("Only query operation is supported.");
            ...
            case UriCode.CCS_SEARCH_RESULTS:
                // FIXME throw exception here and add a new private uri for inserting by PAService
                count = db.update(Tables.CCS_SEARCH, values, where, whereArgs);
                break;
            case UriCode.STATE:
    ...
    private void updateMessageSearchTable(SQLiteDatabase db, Long id) {
        ...
        try {
            ...
            if (c != null && c.getCount() > 0) {
                c.moveToFirst();
                ContentValues cv = new ContentValues();
                cv.put(MessageColumns.TYPE, c.getInt(c.getColumnIndexOrThrow(MessageColumns.TYPE)));
                cv.put(MessageColumns.TEXT, c.getString(c.getColumnIndexOrThrow(MessageColumns.TEXT)));
                cv.put(MessageColumns.DATA1, c.getLong(c.getColumnIndexOrThrow(MessageColumns.DATA1)));
                cv.put(MessageColumns.DATA2, c.getLong(c.getColumnIndexOrThrow(MessageColumns.DATA2)));
                cv.put(MessageColumns.DATA3, c.getLong(c.getColumnIndexOrThrow(MessageColumns.DATA3)));
                cv.put(MessageColumns.DATA4, c.getLong(c.getColumnIndexOrThrow(MessageColumns.DATA4)));
                cv.put(MessageColumns.DATA5, c.getLong(c.getColumnIndexOrThrow(MessageColumns.DATA5)));
    ...
    private void updateLastMessageForAccountTable(SQLiteDatabase db, long accountId) {
        if (accountId != Constants.INVALID) {
            ...
            Cursor c = null;
            try {
                c = db.rawQuery("SELECT " + MessageColumns._ID + " FROM " + Tables.MESSAGE + " WHERE "
                        + MessageColumns.ACCOUNT_ID + "=" + accountId + " ORDER BY " + MessageColumns.TIMESTAMP
                        + " DESC LIMIT 1", null);
                if (c != null && c.getCount() > 0) {
                    c.moveToFirst();
                    messageId = c.getLong(c.getColumnIndexOrThrow(MessageColumns._ID));
                }
            } finally {
                if (c != null) {
                    c.close();
            ...
            db.execSQL("UPDATE " + Tables.ACCOUNT + " SET " + AccountColumns.LAST_MESSAGE + "=" + messageId + " WHERE "
                    + AccountColumns._ID + "=" + accountId);
        }
    }
     ...
     */
    private void updateMessageSearchTable(SQLiteDatabase db, long id, ContentValues values, boolean insertOnly) {
        // update search table
        ContentValues cv = new ContentValues();
        ...
        case Constants.MEDIA_TYPE_TEXT:
            {
                String messageText = values.getAsString(MessageColumns.TEXT);
                cv.put(SearchColumns.MESSAGE_TEXT, messageText);
            }
            break;
        ...
        case Constants.MEDIA_TYPE_AUDIO:
            {
                ...
                try {
                    c = db.query(
                            ...
                            MediaBasicColumns._ID + "=" + values.getAsLong(MessageColumns.DATA1),
                            null,
                            null,
                            null,
                            null);
                ...
                for (int i = 0; i < PAContract.MESSAGE_DATA_COLUMN_LIST.length; ++i) {
                    try {
                        c = db.query(
                                ...
                                MediaBasicColumns._ID + "=" + values.getAsLong(PAContract.MESSAGE_DATA_COLUMN_LIST[i]),
                                null,
                                null,
                                null,
                                null);
                        if (c != null && c.getCount() > 0) {
                            c.moveToFirst();
                            sb.append(c.getString(c.getColumnIndexOrThrow(MediaArticleColumns.TITLE))).append(SEARCH_TEXT_SEPERATOR);
                            sb.append(c.getString(c.getColumnIndexOrThrow(MediaArticleColumns.TEXT))).append(SEARCH_TEXT_SEPERATOR);
                        }
                    } finally {
                        if (c != null) {
                            c.close();
