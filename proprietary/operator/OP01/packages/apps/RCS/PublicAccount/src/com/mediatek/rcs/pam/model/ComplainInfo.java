...
public class ComplainInfo implements SanityCheck {
    ...
    public void checkSanity() throws PAMException {
        ...
        Utils.throwIf(ResultCode.PARAM_ERROR_INVALID_FORMAT,
                (result != Constants.COMPLAIN_RESULT_SUCCESS && result != Constants.COMPLAIN_RESULT_FAILED));
    ...
    public String toString() {
        ...
        sb.append("{_class:\"ComplainInfo\", uuid:\"").append(uuid).append("\", result:\"").append(result)
                .append("\"}");
        return sb.toString();
