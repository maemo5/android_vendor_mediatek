...
public interface PAContract {
    ...
    String[] MESSAGE_DATA_COLUMN_LIST = new String[] { MessageColumns.DATA1, MessageColumns.DATA2,
            MessageColumns.DATA3, MessageColumns.DATA4, MessageColumns.DATA5, };

    public interface MessageHistorySummaryColumns {
        String CONTENT_URI_STRING = "content://" + AUTHORITY + "/" + MESSAGE_HISTORY_SUMMARIES;
        Uri CONTENT_URI = Uri.parse(CONTENT_URI_STRING);

        String _ID = AccountColumns._ID;
    ...
    String[] MESSAGE_HISTORY_SUMMARY_PROJECTION = new String[] { MessageHistorySummaryColumns._ID,
            MessageHistorySummaryColumns.UUID, MessageHistorySummaryColumns.NAME, MessageHistorySummaryColumns.LOGO_ID,
            MessageHistorySummaryColumns.LOGO_PATH, MessageHistorySummaryColumns.LOGO_URL,
            MessageHistorySummaryColumns.LAST_MESSAGE_ID, MessageHistorySummaryColumns.LAST_MESSAGE_SUMMARY,
            MessageHistorySummaryColumns.LAST_MESSAGE_TYPE, MessageHistorySummaryColumns.LAST_MESSAGE_TIMESTAMP, };
    ...
    String[] MEDIA_ARTICLE_TITLE_COLUMN_LIST = new String[] { SearchColumns.MESSAGE_MEDIA_TITLE1,
            SearchColumns.MESSAGE_MEDIA_TITLE2, SearchColumns.MESSAGE_MEDIA_TITLE3, SearchColumns.MESSAGE_MEDIA_TITLE4,
            SearchColumns.MESSAGE_MEDIA_TITLE5, };

    String[] MEDIA_ARTICLE_TEXT_COLUMN_LIST = new String[] { SearchColumns.MESSAGE_ARTICLE_TEXT1,
            SearchColumns.MESSAGE_ARTICLE_TEXT2, SearchColumns.MESSAGE_ARTICLE_TEXT3,
            SearchColumns.MESSAGE_ARTICLE_TEXT4, SearchColumns.MESSAGE_ARTICLE_TEXT5, };
