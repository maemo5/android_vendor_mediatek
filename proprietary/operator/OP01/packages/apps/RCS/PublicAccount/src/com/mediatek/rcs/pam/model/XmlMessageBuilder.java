...
public class XmlMessageBuilder {
    ...
    public String buildGetSubscribedListRequest(int order, int pageSize, int pageNumber, String userId) {
        try {
            GeneralInfo info = GeneralInfo.buildRequestInfo(MessageName.GET_SUBSCRIBED_LIST, userId);
            XmlSerializer serializer = XmlPullParserFactory.newInstance().newSerializer();
            StringWriter writer = new StringWriter();
            serializer.setOutput(writer);
            serializer.startDocument("utf-8", null);
    ...
    public String buildSearchRequest(String keyword, int order, int pageSize, int pageNumber, String userId) {
        try {
    ...
    public String buildGetMessageHistoryRequest(
            ...
            String userId) {
        try {
            GeneralInfo info = GeneralInfo.buildRequestInfo(MessageName.GET_MESSAGE_HISTORY, userId);
            XmlSerializer serializer = XmlPullParserFactory.newInstance().newSerializer();
            StringWriter writer = new StringWriter();
            serializer.setOutput(writer);
            serializer.startDocument("utf-8", null);
