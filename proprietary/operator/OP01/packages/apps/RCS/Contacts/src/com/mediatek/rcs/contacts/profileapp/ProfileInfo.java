...
public class ProfileInfo implements Parcelable {
    ...
    public static String[] mPrimaryInfoKeySet = new String[] {PHONE_NUMBER, NAME, EMAIL, ADDRESS, BIRTHDAY};
    public static String[] mCompanyInfoKeySet = new String[] {COMPANY, TITLE, COMPANY_TEL, COMPANY_ADDR, COMPANY_FAX};

    public static String[] mAllProfileKeySet = new String[] {
        PORTRAIT, PORTRAIT_TYPE, PHONE_NUMBER, FIRST_NAME, LAST_NAME, EMAIL, ADDRESS, BIRTHDAY, PHONE_NUMBER_SECOND,
    ...
    static HashMap<String, String> mAllProfileInfoList = new HashMap<String, String>();

    HashMap<String, String> mPrimaryInfoList = new HashMap<String, String>();
    //HashMap<String, String> mOtherNumberList = new HashMap<String, String>();
    HashMap<String, String> mCompanyInfoList = new HashMap<String, String>();
    ArrayList<OtherNumberInfo> mOtherNumberArrayList = new ArrayList<OtherNumberInfo>();
