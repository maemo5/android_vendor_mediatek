...
public class ProfileInfo implements Parcelable {
    public HashMap<String, String> mProfileMap = null;
    ...
    /**
     * set the profileInfo hashmap to parcel.
     *
     * @param profile is the profileInfo to set
     */
    public void setProfileMap(HashMap profile) {
        mProfileMap = profile;
    }
    ...
    public static final Parcelable.Creator<ProfileInfo> CREATOR =
        ...
        public ProfileInfo createFromParcel(Parcel in) {
            ...
            profileInfo.mProfileMap = in.readHashMap(HashMap.class.getClassLoader());
            return profileInfo;
        }
