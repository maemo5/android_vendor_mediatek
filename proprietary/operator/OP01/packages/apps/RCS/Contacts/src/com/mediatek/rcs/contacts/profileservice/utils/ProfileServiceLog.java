...
public abstract class ProfileServiceLog {
    ...
    public static void d(Object caller, String msg) {
        ...
        Log.d("RCS_PS", className.substring(className.lastIndexOf('.') + 1) + ": "
                + msg);
    }
    ...
    public static void e(Object caller, String msg) {
        ...
        String className = caller.getClass().getName();
        Log.e("RCS_PS", className.substring(className.lastIndexOf('.') + 1) + ": "
                + msg);
    }
}
