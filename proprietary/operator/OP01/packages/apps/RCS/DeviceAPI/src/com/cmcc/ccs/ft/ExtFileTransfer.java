...
public class ExtFileTransfer extends FileTransfer {
     ...
     */
    public FileTransfer transferFileToMul(Set<String> contacts, String filename, FileTransferListener listener) throws RCSServiceNotAvailableException
    {
    	return null;
    }
     ...
     * @throws RCSServiceNotAvailableException
     */
    public FileTransfer transferFileToMul(Set<String> contacts, String filename, String fileicon, FileTransferListener listener) throws RCSServiceNotAvailableException
    {
    	return null;
    }
