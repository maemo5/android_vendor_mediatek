...
public class GsmaManager {
    ...
    public static final String BROADCAST_RCS_REGISTRATION_STATUS = "com.mediatek.rcs.message.REGISTRATION_STATUS_CHANGE";
    public static final String REGISTRATION_STATUS = "status";

    public final static String BROADCAST_RCS_CONFIGURATION_STATUS = "com.orangelabs.rcs.CONFIGURATION_STATUS";
    public final static String CONFIGURATION_STATUS = "status";

    public final static String BROADCAST_RCS_CORESERVICE_DOWN = "com.mediatek.rcs.message.CORESERVICE_DOWN";
    ...
    private static RCSChatServiceImpl sService = null;
     ...
     */
    public static synchronized boolean initialize(RCSChatServiceImpl service) {
