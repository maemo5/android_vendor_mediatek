...
public final class GeoLocService {
    ...
    public static final String GET_LOC_ASYNC = "get_loc_async";
    
    private static final String TAG = "GeoLocService";
    ...
    public String queryCurrentGeoLocation(GeoLocService.callback cb) {
        ...
        */
        ...
        if (mLocationManager.isProviderEnabled(LocationManager.GPS_PROVIDER) && 
            mLocationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
            mProvider = LocationManager.GPS_PROVIDER; //FUSE_PROVIDER;
        } else if (mLocationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            mProvider = LocationManager.GPS_PROVIDER;
        } else if (mLocationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
            mProvider = LocationManager.NETWORK_PROVIDER;
        }
        Log.i(TAG, "getProvider, mProvider=" + mProvider);
        if (mProvider != null) {
            mMyHandler.removeMessages(MSG_ID_GET_LOC_TIMEOUT);
    ...
    public void removeCallback() {
        Log.i(TAG, "removeCallback, mProvider=" + mProvider);
        cancelQueryGeoLocation();
    }
    
    private void cancelQueryGeoLocation() {
        Log.i(TAG, "cancelQueryGeoLocation, mProvider=" + mProvider);
