...
public class SpamMsgActivity extends ListActivity {
    ...
    private static final Uri SPAM_URI = Uri.parse("content://com.mediatek.message.spam");
...
//        mIsPause = false;
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (mActionMode == null) {
            if (Constants.MSG_TYPE_MMS == type && path == null) {
    ...
    private class SpamCursorAdapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            CharSequence body = emojiImpl.getEmojiExpression(contentStr, true);
