...
public class RCSVCardAttachment {
    ...
    public String getVCardFileNameByContactsId(long[] contactsIds, boolean isAddingIpMessageVCardFile) {
        Log.d(TAG, "getVCardFileNameByContactsId(): isAddingIpMessageVCardFile = " + isAddingIpMessageVCardFile);
            ...
            try {
                if (isAddingIpMessageVCardFile) {
                    writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(
                        RcsMessageUtils.getCachePath(mContext) + fileName)));
                } else {
    ...
    public String getVCardFileNameByUri(Uri uri) {
        ...
        String filePath = RcsMessageUtils.getCachePath(mContext) + filename;
        try {
            InputStream in = null;
    ...
    private String getVCardFileNameForIpMessage(long[] contactIds) {
        ...
        if (contactIds.length == 1) {
            ...
            fileName = mContext.getString(R.string.multi_cantacts_name);
        }
        return fileName + ".vcf";
    }
}
