...
public final class IpMessageConsts {
    ...
    public static final String ACTION_GROUP_NOTIFICATION_CLICKED =
            "com.mediatek.mms.ipmessage.group_notification_clicked";
    public static final String ACTION_DEL_IP_MSG_DONE =
            "com.mediatek.mms.ipmessage.delIpMsgDone";
    public static final String ACTION_SERVICE_READY =
            "com.mediatek.mms.ipmessage.service.ready";
    public static final String ACTION_UPGRADE =
            "com.mediatek.mms.ipmessage.upgrade";
    ...
    public static final class MessageProtocolType {
        /**
         * protocol for multi message in sms table
         */
        public static final int RCS_MULTI_PROTO = 10;
        public static final int RCS_BURN_PROTO  = 11;
    }

    public static final class FileTransferType {
        public static final char FT_TYPE_IMAGE = 0x01;
        public static final char FT_TYPE_VIDEO = 0x02;
        public static final char FT_TYPE_AUDIO = 0x03;
        public static final char FT_TYPE_VCARD = 0x04;
    }
    ...
    public static final class JoynGroupInvite {
        public static final String ACTION_GROUP_IP_INVITATION =
                "com.mediatek.mms.ipmessage.groupinvitation";
    }
    ...
    public static final class ServiceStatus {
        public static final String ACTION_SERVICE_STATUS =
                "com.mediatek.mms.ipmessage.serviceStatus";
        public static final int ON  = 1;
        public static final int OFF = 0;
    }

    public static final class ImStatus {
        public static final String ACTION_IM_STATUS =
                "com.mediatek.mms.ipmessage.IMStatus";
        public static final String CONTACT_CURRENT_STATUS =
                "com.mediatek.mms.ipmessage.ContactStatus";
    }
...
//        public static final int STATUS_BLOCKING    = 2;
    ...
    public static final class DownloadAttachStatus {
        public static final String ACTION_DOWNLOAD_ATTACH_STATUS =
                "com.mediatek.mms.ipmessage.downloadAttachStatus";
    ...
    public static final class SetProfileResult {
        public static final String ACTION_SET_PROFILE_RESULT =
                "com.mediatek.mms.ipmessage.setProfileResult";
        public static final int SUCCEED = 0;
        public static final int FAILED  = 1; // or -1 is better?
    }

    public static final class BackupMsgStatus {
        public static final String ACTION_BACKUP_MSG_STATUS =
                "com.mediatek.mms.ipmessage.backupMsgStatus";
    ...
    public static final class RestoreMsgStatus {
        public static final String ACTION_RESTORE_MSG_STATUS =
                "com.mediatek.mms.ipmessage.restoreMsgStatus";
        public static final String DOWNLOAD_PERCENTAGE = "DownloadPercentage";
        public static final int STARTING = 0;
    ...
    public static final class IpMessageType {
        ...
        public static final int GEOLOC = 14;
        public static final int EMOTICON = 15;
    }
    ...
    public static final class RemoteActivities {
        ...
        public static final String CONTACT = "content://contact_selection/"
                + Integer.toString(ID_CONTACT);
        public static final String NON_IPMESSAGE_CONTACT =
                "content://non_ipmessage_contact_selection/"
                + Integer.toString(ID_NON_IPMESSAGE_CONTACT);
        public static final String NEW_GROUP_CHAT = "content://new_group_chat/"
                + Integer.toString(ID_NEW_GROUP_CHAT);
        public static final String QUICK_CONTACT = "content://quick_contact/"
                + Integer.toString(ID_QUICK_CONTACT);
        public static final String MEDIA_DETAIL = "content://media_detail/"
                + Integer.toString(ID_MEDIA_DETAIL);
        public static final String AUDIO = "content://audio/" + Integer.toString(ID_AUDIO);
        public static final String SERVICE_CENTER = "content://service_center/"
                + Integer.toString(ID_SERVICE_CENTER);
    ...
    public static final int[] ICON_SELECT = { drawable.ipmsg_emoticon_default_h,
            drawable.ipmsg_emoticon_default_n, drawable.ipmsg_emoticon_xm_h,
            drawable.ipmsg_emoticon_xm_n, drawable.ipmsg_emoticon_ad_h,
            drawable.ipmsg_emoticon_ad_n, drawable.ipmsg_emoticon_rabbit_h,
            drawable.ipmsg_emoticon_rabbit_n, drawable.ipmsg_emoticon_dragon_h,
    ...
    public static final int[] LARGE_ICON_ARR = {drawable.emo_praise, drawable.emo_gift,
            ...
            drawable.emo_boring, drawable.emo_cry, drawable.emo_driving, drawable.emo_eating,
            drawable.emo_happy, drawable.emo_hold, drawable.emo_holiday, drawable.emo_love,
            drawable.emo_pray, drawable.emo_pressure, drawable.emo_sing, drawable.emo_sleep,
    ...
    public static final int[] DYNAMIC_PNG_ICON_ARR = { drawable.emo_dynamic_01_png,
            drawable.emo_dynamic_02_png, drawable.emo_dynamic_03_png, drawable.emo_dynamic_04_png,
            drawable.emo_dynamic_05_png, drawable.emo_dynamic_06_png, drawable.emo_dynamic_07_png,
            drawable.emo_dynamic_08_png, drawable.emo_dynamic_09_png, drawable.emo_dynamic_10_png,
            drawable.emo_dynamic_11_png, drawable.emo_dynamic_12_png, drawable.emo_dynamic_13_png,
            drawable.emo_dynamic_14_png, drawable.emo_dynamic_15_png, drawable.emo_dynamic_16_png,
            drawable.emo_dynamic_17_png, drawable.emo_dynamic_18_png, drawable.emo_dynamic_19_png,
            drawable.emo_dynamic_20_png, drawable.emo_dynamic_21_png, drawable.emo_dynamic_22_png,
            drawable.emo_dynamic_23_png, drawable.emo_dynamic_24_png };
