...
//This is a common logger for MTK RCS solution.
public final class Logger {
    public static final String TAG = "[CMCCRCS]";
    ...
    /**
     * Run-time set whether need to enable the RCS log in this process.
     * 
     * @param isLogEnable Enable/disable the RCS log.
     */
