...
public class FileStruct {
    ...
    public FileStruct(String filePath, String name, long size, String fileTransferTag, Date date, String remote) {
        mFilePath = filePath;
        mName = name;
        mSize = size;
        mFileTransferTag = fileTransferTag;
    ...
    public FileStruct(String filePath, String name, long size, String fileTransferTag, Date date,boolean isBurn, String remote, String thumbNail) {
        mFilePath = filePath;
        mName = name;
        mSize = size;
        mFileTransferTag = fileTransferTag;
    ...
    public FileStruct(String filePath, String name, long size, String fileTransferTag, Date date, String remote, String thumbNail, boolean burnType, int duration) {
        mFilePath = filePath;
        mName = name;
        mSize = size;
        mFileTransferTag = fileTransferTag;
        ...
        mRemote = remote;
        mThumbnail = thumbNail;
        mSessionType = burnType;
        mDuration = duration;
    }
    
    public FileStruct(String filePath, String name, long size, String fileTransferTag, Date date, Set<String> remotes, String thumbNail, int duration) {
        mFilePath = filePath;
        mName = name;
        mSize = size;
        mFileTransferTag = fileTransferTag;
