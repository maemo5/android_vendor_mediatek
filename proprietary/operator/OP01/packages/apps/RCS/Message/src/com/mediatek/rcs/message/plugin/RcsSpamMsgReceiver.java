...
import com.mediatek.rcs.common.provider.ThreadMapUtils;
import com.mediatek.rcs.common.utils.ContextCacher;
import com.mediatek.rcs.common.utils.RCSUtils;
import com.android.internal.telephony.PhoneConstants;


public class RcsSpamMsgReceiver extends IpSpamMsgReceiver {
...
//    };
   ...
   /*
    ...
    private boolean onIphandlePushSpamMsg(Context context, Intent intent) {
        ...
        ThreadMapUtils.getInstance(context);
        if((type == MESSAGE_TYPE_NOTIFICATION_IND) && RCSUtils.isIpSpamMessage(mContext, contact)) { 
            Log.d(TAG, "received spam push message, intent="+ intent);
            SpamMsgUtils spamUtils = SpamMsgUtils.getInstance(context);
            
//            spamUtils = SpamMsgUtils.getInstances();
