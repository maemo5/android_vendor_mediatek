...
public class PageAdapter extends BaseAdapter {
    ...
    public void registerListener(OnEmotionItemSelectedListener listener) {
        ...
        if (listener == null) {
            Xlog.d(TAG, "registerListener() failed because listener is null");
            return;
        }
        mListener = listener;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        Xlog.d(TAG, "getView() position=" + position);
...
//            currentView = new ImageView(mContext);
        ...
        Xlog.d(TAG, "getView() integer=" + integer);
