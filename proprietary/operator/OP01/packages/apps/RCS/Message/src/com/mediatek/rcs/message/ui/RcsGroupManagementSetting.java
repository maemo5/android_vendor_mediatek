...
public class RcsGroupManagementSetting extends PreferenceActivity implements
    ...
    private void setupPreference() {
        ...
        mNickName.getEditText().setFilters(new InputFilter[] { new EditTextInputFilter() });
        ...
        mSelfNickName.getEditText().setFilters(new InputFilter[] { new EditTextInputFilter() });
    ...
    private class RCSGroupAsyncTask extends AsyncTask<Void, Void, Long> {
        ...
        protected Long doInBackground(Void... arg0) {
            mRCSGroup = GroupManager.getInstance(mContext).getRCSGroup(mGroupChatId);
            if (mRCSGroup != null) {
    ...
    private class EditTextInputFilter implements InputFilter {
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest,
            ...
            if (newLength > MAX_SUBJECT_LENGTH) {
                ...
                Toast.makeText(RcsGroupManagementSetting.this, R.string.subject_len_reach_max,
