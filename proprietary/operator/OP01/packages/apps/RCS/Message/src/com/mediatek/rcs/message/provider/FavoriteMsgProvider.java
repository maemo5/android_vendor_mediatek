...
public class FavoriteMsgProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.mediatek.message.favorite";

    // Allocate the UriMatcher object
    private static final UriMatcher uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
    static {
        uriMatcher.addURI(AUTHORITY, null, URI_FAVORITE_ALL);
        uriMatcher.addURI(AUTHORITY, "#", URI_FAVORITE_ID);
    }
...
//    };
    ...
    private int deleteFavoriteMsgs(SQLiteDatabase db,
        ...
        Cursor cursor = db.query(TABLE_FAVORITE, new String[] { "type","path" },
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                try {
                    ...
                    int mType = cursor.getInt(cursor.getColumnIndexOrThrow("type"));
                    if (mType == 2 || mType == 3) {
    ...
    private void notifyChange() {
        ...
        cr.notifyChange(CONTENT_URI, null, false);
    }
