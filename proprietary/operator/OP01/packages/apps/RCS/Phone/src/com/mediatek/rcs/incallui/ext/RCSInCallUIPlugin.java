...
public class RCSInCallUIPlugin {
    public static RCSInCallUIPlugin sRCSInCallUIPlugin;
    ...
    public static RCSInCallUIPlugin getInstance() {
        if (sRCSInCallUIPlugin == null) {
            sRCSInCallUIPlugin = new RCSInCallUIPlugin();
        }
        return sRCSInCallUIPlugin;
    }
