...
public class Op01GalleryPickerExt extends DefaultGalleryPickerExt {
    ...
    @Override
    public ActionModeHandler onPageCreate(AbstractGalleryActivity activity, Bundle data,
        ...
        Log.d(TAG, "onPageCreate mRcsPicker: " + mRcsPicker
              + ", mMaxSelectionNum: " + mMaxSelectionNum);
        return actionMode;
    }

    @Override
    public void onPageResume(SelectionManager selectMgr) {
        Log.d(TAG, "onPageResume mRcsPicker: " + mRcsPicker);
        if (mRcsPicker) {
    ...
    public void onPagePause() {
        Log.d(TAG, "onPagePause mRcsPicker: " + mRcsPicker);
    }

    @Override
    public void onPageDestroy() {
        Log.d(TAG, "onPageDestroy mRcsPicker: " + mRcsPicker);
    }
