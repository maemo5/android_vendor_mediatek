 ...
 *
 */
/* Vanzo:yujianpeng on: Wed, 10 Sep 2014 11:22:43 +0800
 * implement 79616 modify for 3rd-party App
 */
...
/* Vanzo:yujianpeng on: Wed, 10 Sep 2014 15:59:02 +0800
 ...
 */
            ...
            int types_ext[] = new int[10] ;
            boolean mIsGoogleOrigCalendarExist = false;
            boolean mIsGoogleOrigMusicExist = false;
            try {
...
// End of Vanzo:yujianpeng
            for (int i = 0; i < num; i++) {
                ...
                int count = 0;
                Composer composer;
/* Vanzo:yujianpeng on: Wed, 10 Sep 2014 15:53:34 +0800
 * implement 79616 modify for 3rd-party App
                switch (types[i]) {
 */
                switch (types_ext[i]) {
// End of Vanzo:yujianpeng
                ...
                composer = null;
                bEnabled = !(count == 0);
/* Vanzo:yujianpeng on: Wed, 10 Sep 2014 15:54:44 +0800
 * implement 79616 modify for 3rd-party App
                PersonalItemData item = new PersonalItemData(types[i], bEnabled);
 */
                PersonalItemData item = new PersonalItemData(types_ext[i], bEnabled);
// End of Vanzo:yujianpeng
                if (!skipAppend) {
