...
public class HttpsProvisioningService extends Service {
	...
	HttpsProvisioningNetwork mProvisioningNetwork = null;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        else if (needSeparateConnection()) {
            mProvisioningNetwork = new HttpsProvisioningNetwork(this);
            try {
                long subID=(long)SubscriptionManager.getDefaultDataSubId();
                //Long subID= LauncherUtils.getsubId();
                httpsProvisioningMng.separateNetworkConnection.acquireNetwork(subID);
                httpsProvisioningMng.registerSeperateNetworkStateListener();
             //   HttpsProvisioningManager.needUpdateConfig(this);
