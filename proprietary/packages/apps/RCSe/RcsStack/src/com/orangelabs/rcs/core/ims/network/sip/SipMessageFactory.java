...
public class SipMessageFactory {
    ...
    public static SipRequest createRegister(SipDialogPath dialog, List<String> featureTags, int expirePeriod, String instanceId) throws SipException {
		try {
            ...
            if(RcsSettings.getInstance().isCPMBurnAfterReadingSupported()){
            	...
            	ContactheaderString += ""+FeatureTags.FEATURE_RCSE_CPM_BURN_AFTER_READING_FEATURE_TAG;
    ...
    public static SipRequest createCpimSubscribe(SipDialogPath dialog, int expirePeriod) throws SipException {
		try {
			...
			// Set the preferred service header
					Header allowEvents = SipUtils.HEADER_FACTORY.createAllowEventsHeader("presence,presence.winfo");
 ...
 /**
	 ...
	 * @throws SipException
	 */
    public static SipRequest createCpimChatListSubscribe(SipDialogPath dialog, int expirePeriod,int version) throws SipException {
		try {
			if (logger.isActivated()) {
	        ...
	        Header eventHeader =  SipUtils.HEADER_FACTORY.createHeader(EventHeader.NAME, "grouplist");
	        subscribe.addHeader(eventHeader);
	        
	        // Set the Accept header
	    	//subscribe.addHeader(AcceptHeader.NAME, "application/conference-info+xml"); 
	    	Header acceptHeader =  SipUtils.HEADER_FACTORY.createHeader(AcceptHeader.NAME, "application/conference-info+xml");
    		...
    		// Set the message content
	    	if (document != null) {
	    		ContentTypeHeader contentTypeHeader = SipUtils.HEADER_FACTORY.createContentTypeHeader("application","grouplist-ver+xml");
	 ...
	 * @throws SipException
	 */
	public static SipRequest createMessageCPM(SipDialogPath dialog, String featureTag, String contentType, String content) throws SipException {
		try {			
	        // Set request line header
	        URI requestURI = SipUtils.ADDR_FACTORY.createURI(dialog.getTarget());
			...
			// Set the preferred service header
			Header preferredServiceHeader = SipUtils.HEADER_FACTORY.createHeader(SipUtils.HEADER_P_PREFERRED_SERVICE, FeatureTags.FEATURE_RCSE_PAGER_MSG);
     ...
     * @throws SipException
     */
    public static SipRequest createMessageMultiCPM(SipDialogPath dialog, String featureTag, String contentType, String content) throws SipException {
        try {           
            // Set request line header
            URI requestURI = SipUtils.ADDR_FACTORY.createURI(dialog.getTarget());
         ...
         // Set the Require header
            RequireHeader requireHeader = SipUtils.HEADER_FACTORY.createRequireHeader("recipient-list-message");
     ...
     * @throws SipException
     */
    public static SipRequest createLargeMessageCpmInvite(SipDialogPath dialog,	String[] featureTags, String sdp) throws SipException {
		try {
			if (logger.isActivated()) {
     ...
     * @throws SipException
     */
    public static SipRequest createLargeMessagecmccCpmInvite(SipDialogPath dialog,	String[] featureTags, String sdp,String boundary) throws SipException {
		try {
			if (logger.isActivated()) {
			     logger.info("CPMS createLargeMessageCpmInvite: target" + dialog.getTarget());
			 }
     ...
     * @throws SipException
     */
    public static SipRequest createPublicAccountCpmInvite(SipDialogPath dialog,  String[] featureTags, String sdp) throws SipException {
        try {
            if (logger.isActivated()) {
                 logger.info("CPMS createCpmInvite: target" + dialog.getTarget());
             }
...
/**
     ...
     * @throws SipException
     */
    public static SipRequest createOneToMultiCpimInvite(SipDialogPath dialog,
    		String[] featureTags,
			String content,
			ContentTypeHeader contentType)
            throws SipException {
		try {
			...
			// Set the preferred service header
			Header preferredServiceHeader = SipUtils.HEADER_FACTORY.createHeader(SipUtils.HEADER_P_PREFERRED_SERVICE, FeatureTags.FEATURE_CPM_MSG);
			invite.addHeader(preferredServiceHeader);
     ...
     * @throws SipException
     */
    public static SipRequest createCpimPublicInvite(SipDialogPath dialog,
    		String[] featureTags,
			String content,
			ContentTypeHeader contentType)
            throws SipException {
		try {
			...
			/// Set the preferred service header
            Header preferredServiceHeader = SipUtils.HEADER_FACTORY.createHeader(SipUtils.HEADER_P_PREFERRED_SERVICE, FeatureTags.FEATURE_CMCC_PUBLIC_ACCOUNT);
            invite.addHeader(preferredServiceHeader);
     ...
     * @throws SipException
     */
    public static SipRequest createLargeCpimInvite(SipDialogPath dialog,
    		String[] featureTags,
			String content,
			ContentTypeHeader contentType)
            throws SipException {
    ...
    public static SipRequest createGroupBye(SipDialogPath dialog) throws SipException {
        try {
         ...
         // Set "rport" (RFC3581)
            String contact = "<sip:"+dialog.getSipStack().getLocalIpAddress()+":"+dialog.getSipStack().getListeningPort()+
                             ";transport="+dialog.getSipStack().getProxyProtocol()+">;"+"*;+group.policy=\"gclose\"";
            //Header contactHeader = SipUtils.HEADER_FACTORY.createHeader(ContactHeader.NAME, "*;+group.policy=\"gclose\"");
    ...
    public static SipRequest createOptions(SipDialogPath dialog, List<String> featureTags) throws SipException {
		try {
        	...
        	isburnSupported = featureTags.contains(FeatureTags.FEATURE_RCSE_CPM_BURN_AFTER_READING_FEATURE_TAG);
        	if(isburnSupported){
     ...
     * @throws SipException
     */
    public static SipRequest createReferModifySubject(SipDialogPath dialog, String toContact, String newSubject, String contributionId) throws SipException {
        try {           
            // Create the request
            Request refer = dialog.getStackDialog().createRequest(Request.REFER);
     ...
     * @throws SipException
     */
    public static SipRequest createReferModifyNickname(SipDialogPath dialog, String toContact, String newNickname, String contributionId) throws SipException {
        try {           
            // Create the request
            Request refer = dialog.getStackDialog().createRequest(Request.REFER);
     ...
     * @throws SipException
     */
    public static SipRequest createReferRemoveParticipant(SipDialogPath dialog, String chairman, String participantToRemove, String contributionId) throws SipException {
        try {           
            // Create the request
            Request refer = dialog.getStackDialog().createRequest(Request.REFER);
     ...
     * @throws SipException
     */
    public static SipRequest createReferTransferChairman(SipDialogPath dialog, String oldChairman, String newChairman, String contributionId) throws SipException {
        try {           
            // Create the request
            Request refer = dialog.getStackDialog().createRequest(Request.REFER);
            ...
            String newToContact = "Refer-To: "+"<" +dialog.getTarget()+">" + ";method=SETPLC;plccmd=gaccede; plcvalue="+newChairman;
            ...
            String headerString = "*;"+FeatureTags.FEATURE_RCSE_CPM_SESSION+ ";" + FeatureTags.FEATURE_CPM_GROUP_CMCC ;
            Header acceptContactHeader = SipUtils.HEADER_FACTORY.createHeader(SipUtils.HEADER_ACCEPT_CONTACT, headerString);
