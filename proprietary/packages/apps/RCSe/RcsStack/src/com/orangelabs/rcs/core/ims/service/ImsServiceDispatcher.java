...
/**
    ...
    private void dispatchNotify(SipRequest notify) {
	    ...
	    if (eventHeader.getEventType().equalsIgnoreCase("presence")) {
	        ...
	        if (eventHeader.getEventType().equalsIgnoreCase("grouplist")) {
	            //group chat list information
	            imsModule.getInstantMessagingService().receiveGroupListNotification(notify);
	        } else
