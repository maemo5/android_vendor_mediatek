...
/*@*/
		...
		if (RcsSettings.getInstance().isCPMBurnAfterReadingSupported()) {
            tags.add(FeatureTags.FEATURE_RCSE_CPM_BURN_AFTER_READING_FEATURE_TAG);
        }
    ...
    public static Capabilities extractCapabilities(SipMessage msg) {
    	...
    	for(int i=0; i < tags.size(); i++) {
    		 ...
    		 * BURN AFTER READ
    		 */
    		else if (tag.contains(FeatureTags.FEATURE_RCSE_CPM_BURN_AFTER_READING_FEATURE_TAG.toLowerCase())) {
