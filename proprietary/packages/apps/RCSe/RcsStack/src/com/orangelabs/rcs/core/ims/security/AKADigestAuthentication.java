 ...
 * 
 * @author mtk33054 TODO integrate in common AKA SHA/MD5
 */
public class AKADigestAuthentication {
	...
	//FIX IT
	private String algorithm = "AKAv1-MD5";//TODO , just to make sure first request has MD5 as per vendor . 
	...
	public  byte[] calculateAkaAuthAndRes(byte[] rand, byte[] autn,
			long subId) {
	...
	public String calculateResponse(String user, String password, String method, String uri, String nc, String body) throws Exception {
		...
		String tmpStr = user + ":" + realm + ":";
		//use hexdump as passwd is in hex
		String a1 = HexDump.toHexString(tmpStr.getBytes()) + password;
