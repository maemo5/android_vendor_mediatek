...
public class OriginatingOne2MultiStandAloneChatSession extends GroupChatSession {
	 ...
	 */
	public OriginatingOne2MultiStandAloneChatSession(ImsService parent, String conferenceId, String subject, ListOfParticipant participants) {
	...
	private SipRequest createInviteRequest(String content) throws SipException {
		...
		if(!RcsSettings.getInstance().isCPMSupported()){
			...
			if (logger.isActivated()) {
			 ...
			 invite = SipMessageFactory.createOneToMultiCpmMultipartInvite(getDialogPath(), 
