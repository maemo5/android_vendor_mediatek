...
/**M
     ...
     * @param session Chat session
     */
	public void handleOneOneStandAloneChatSessionInvitation(TerminatingOne2OneStandAloneChatSession session) {
		if (logger.isActivated()) {
			logger.debug("Handle event receive 1-1 chat session invitation");
		}
		
    	// Broadcast the invitation
		chatApi.receiveOneOneStandAloneChatInvitation(session);
    }
