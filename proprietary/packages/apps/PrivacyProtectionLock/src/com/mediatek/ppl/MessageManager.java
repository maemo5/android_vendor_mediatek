...
/* Vanzo:hanshengpeng on: Thu, 05 Mar 2015 09:35:08 +0800
 * custom sms templates
 */
        mMessageTemplates[1] = mMessageTemplates[1].replace("#suoding#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#"));
        mMessageTemplates[3] = mMessageTemplates[3].replace("#jiesuo#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_UNLOCK.replace("$","#"));
        mMessageTemplates[5] = mMessageTemplates[5].replace("#mima#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#"));
        mMessageTemplates[7] = mMessageTemplates[7].replace("#xiaohui#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#"));
        mMessageTemplates[10] = mMessageTemplates[10].replace("#suoding#",
                FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#")).replace("#mima#",
                FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#")).replace("#xiaohui#",
                FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#"));

        patternStrings[1] = mMessageTemplates[1].replace("#suoding#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#"));
        patternStrings[3] = mMessageTemplates[3].replace("#jiesuo#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_UNLOCK.replace("$","#"));
        patternStrings[5] = mMessageTemplates[5].replace("#mima#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#"));
        patternStrings[7] = mMessageTemplates[7].replace("#xiaohui#", FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#"));
        patternStrings[10] = mMessageTemplates[10].replace("#suoding#",
                FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_LOCK.replace("$","#")).replace("#mima#",
                FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_PASSWORD.replace("$","#")).replace("#xiaohui#",
                FeatureOption.VANZO_FEATURE_STRING_SMS_TEMPLATES_DESTROY.replace("$","#"));
// End of Vanzo:hanshengpeng
