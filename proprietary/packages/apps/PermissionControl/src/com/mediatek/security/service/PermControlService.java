...
/* Vanzo:tanglei on: Mon, 09 Feb 2015 16:46:19 +0800
 */
...
public class PermControlService extends AsyncService implements OnClickListener, OnDismissListener {
    ...
    private void initService() {
        ...
        registerReceiver();
/* Vanzo:tanglei on: Mon, 09 Feb 2015 16:48:01 +0800
 * remove app permission notify
        setServiceInforeground();
 */
        if (!FeatureOption.VANZO_FEATURE_REMOVE_APP_PERMISSION_NOTIFY) {
            setServiceInforeground();
        }
// End of Vanzo:tanglei
    }
...
/* Vanzo:tanglei on: Mon, 09 Feb 2015 16:50:48 +0800
 * remove app permission notify
