...
PRJ_MF := zprojects/$(project_name)/$(project_name).mk
endif
...
# Vanzo:wangfei on: Sat, 15 Nov 2014 11:24:12 +0800
# added by wf for include the new config to override the default config
