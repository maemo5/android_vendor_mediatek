...
#define BES_LOUDNESS_HCF_L_BPF_FC       400,600,0,0,0,0,0,0
#define BES_LOUDNESS_HCF_L_BPF_BW       1200,1400,0,0,0,0,0,0
#define BES_LOUDNESS_HCF_L_BPF_GAIN     2 << 8,2 << 8,0 << 8,0 << 8,0 << 8,0 << 8,0 << 8,0 << 8
