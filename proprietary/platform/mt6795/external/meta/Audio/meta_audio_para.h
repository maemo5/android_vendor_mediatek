...
typedef enum {
    FT_L4AUD_OP_AUDIO_QUERY_ID = 0
                                 ...
                                 , FT_L4AUD_OP_GET_CTRPOINT_TABLE   //55
                                 , FT_L4AUD_OP_GET_HDREC_INFO
                                 , FT_L4AUD_OP_GET_SUPPORT_AFE_REG_ACCESS_FUNC
                                 , FT_L4AUD_OP_RUN_AFE_REG_ACCESS_FUNC      //58                                 
                                 , FT_L4AUD_OP_GET_MIC_MASK
                                 , FT_L4AUD_OP_MIC3_LOOPBACK
                                 , FT_L4AUD_OP_MIC4_LOOPBACK
                                 , FT_L4AUD_OP_END
}
FT_L4AUD_OP;
...
typedef union
{
    ...
    ft_l4aud_hdrec_info_cnf                 hd_record_info;
    ft_l4aud_mic_num_cnf                   get_mic_num_cnf;
    unsigned int                          dummy;            // extend alignment to 4 bytes
} ft_l4aud_confirm;
...
typedef unsigned short FT_L4AUD_MIC_MASK;
